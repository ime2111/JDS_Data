...
keep if day > 226
save "/Users/isminiethridge/Dropbox/IE_COVID-19/Lancet Covid-19 Data/2 wk average Aug 29.dta", replace
...
egen pos_rate_2wk_avg = mean(positive_rate), by(iso3)
...
replace suppression = 1 if ncpm_2wk_avg <= 5 & pos_rate_2wk_avg < .01 & missing_data != 1
replace low_level = 1 if ncpm_2wk_avg > 5 & ncpm_2wk_avg < 50 & pos_rate_2wk_avg < .05 & missing_data != 1
replace high_level = 1 if ncpm_2wk_avg > 50 & missing_data != 1
replace high_level = 1 if pos_rate_2wk_avg > .05 & missing_data != 1
...
replace low_level_2 = 1 if ncpm_2wk_avg > 5 & ncpm_2wk_avg < 50 & pos_rate_2wk_avg < .03 & ERR_2wk_avg < 1 & missing_data_2 != 1
replace moderate_level_2 = 1 if ncpm_2wk_avg > 5 & ncpm_2wk_avg < 50 & pos_rate_2wk_avg > .03 & missing_data_2 != 1
