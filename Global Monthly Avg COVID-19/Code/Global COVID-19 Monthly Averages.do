...
replace month_num = 15 if day > 425 & day <= 456
replace month_num = 16 if day > 456 & day <= 486
replace month_num = 17 if day > 486 & day <= 517
replace month_num = 18 if day > 517 & day <= 547
replace month_num = 19 if day > 547 & day <= 578
